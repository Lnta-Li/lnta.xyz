...
$helpurl = "https://help.dedecms.com/anquan/";
$safeMsg[] = '<a href="'.$helpurl.'" style="color:red;text-decoration:underline;" target="_blank">点击阅读教程 “如何做好 DedeCMS 网站的安全工作”</a>';
...
if (file_exists($filename)) {
	...
	if ($arr_password[$userid] != '') {
		$timestamp = $arr_password[$userid];
		if ($timestamp + $interval_time < time()) {
			$date = date('Y-m-d H:i:s', $timestamp);
			$safeMsg[] = "您上次更换密码的时间是：{$date}，强烈建议您定期更换密码；";
		}
	}
}
